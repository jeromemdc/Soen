 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'gfm_021387-facilitator_api1.yahoo.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? '1381548165' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'Am6d2FcDYGUUnppycHkY2G9kNGFtA0SUOAsDuUmqiKfaKE2gme08WJjt' : 'PRODUCTION_SIGNATURE_GOES_HERE';
...
$config['PayFlowPassword'] = $config['Sandbox'] ? 'SANDBOX_USERNAME_GOGES_HERE' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['PayFlowVendor'] = $config['Sandbox'] ? 'SANDBOX_USERNAME_GOGES_HERE' : 'PRODUCTION_VENDOR_GOES_HERE';
$config['PayFlowPartner'] = $config['Sandbox'] ? 'SANDBOX_USERNAME_GOGES_HERE' : 'PRODUCTION_PARTNER_GOES_HERE';
