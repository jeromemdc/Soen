...
<div id="content" class="content">
    ...
    <!-- begin row -->
    <form action="<?=base_url()?>administrator/add_collection?route=catalog" enctype="multipart/form-data" method="post" accept-charset="utf-8" data-parsley-validate="true">
    <div class="row">
        <!-- begin col-6 -->
        <div class="col-md-12">
            ...
            <div class="tab-content">
                <div class="tab-pane fade active in" id="default-tab-1">
                    <div class="panel-body form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Collection Name <code>*</code></label>
                            <div class="col-md-6">
